...
@company_router.post("/send-join-request/{company_id}")
...
@company_router.delete("/cancel-join-request/{company_id}")
...
@company_router.post("/accept-join-request/{company_id}/{user_id}")
...
@company_router.post("/reject-join-request/{company_id}/{user_id}")
